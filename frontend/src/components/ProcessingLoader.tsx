      ...
      <div className="max-w-lg w-full bg-white rounded-2xl shadow-sm p-12 flex flex-col items-center gap-8">
            ...
            <div className="space-y-4">
              ...
              <div className="text-center">
                <div className="flex items-center justify-center gap-3 mb-2">
                  <div className={`w-3 h-3  flex-shrink-0 ${applicant.cv_data ? 'bg-emerald-500' : 'bg-gray-200'}`}></div>
        ...
        <div className="w-full max-w-xs">
          <div className="w-full bg-gray-100  h-1">
            <div
              className="bg-gradient-to-r from-emerald-500 to-blue-500 h-1  transition-all duration-500 ease-out"
              style={{
