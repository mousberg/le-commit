  ...
  return (
    <aside className="w-72 bg-white border-r border-zinc-200 flex flex-col py-6 px-4 gap-4">
      <div className="mb-4">
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            ...
            className="p-1.5  hover:bg-zinc-100 text-zinc-500 hover:text-zinc-700 transition-colors disabled:opacity-50"
        ...
        {isLoading ? (
          <div className="flex justify-center py-8">
            <div className="w-6 h-6 border-2 border-zinc-300 border-t-zinc-800  animate-spin"></div>
          </div>
        ) : applicants.length === 0 ? (
          <div className="text-center py-6 px-2 border border-dashed border-zinc-300 ">
            ...
            {applicants.map(applicant => (
              <li key={applicant.id} className="group relative">
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center flex-1">
                      <div className="w-8 h-8 bg-zinc-100  flex items-center justify-center mr-3">
                ...
                <button
                  ...
                  className="absolute right-2 top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-opacity p-1.5 hover:bg-red-50  text-red-600 hover:text-red-700 z-10"
      ...
      <Button
        onClick={onSelectNew}
        disabled={isLoading}
        className="w-full  bg-zinc-900 hover:bg-zinc-800 text-white font-medium py-3 transition-colors disabled:opacity-50"
      >
        + Add New Applicant
      </Button>
    </aside>
