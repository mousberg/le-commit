  ...
  return (
    <main className="w-full">
      ...
      <div className="relative py-32 sm:py-48 lg:py-60 select-none bg-gradient-to-t from-pink-100 to-pink-200" id="waitlist-form">
        {/* Island animation layers - visible only on large screens */}
        ...
        <div className="relative text-center z-[1] mx-auto max-w-3xl lg:pb-16">
          ...
          <div className="mt-10 max-w-lg mx-auto">
            <div className="bg-white/20 backdrop-blur-md border border-white/30 rounded-full p-2 shadow-lg transition-all duration-300 hover:shadow-[0_0_30px_rgba(255,105,180,0.3)] focus-within:shadow-[0_0_30px_rgba(255,105,180,0.5)] focus-within:border-pink-300/50">
        ...
        {/* UI Preview - positioned like the original */}
